    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20">
        <div className="container max-w-3xl px-4">
          ...
          <div className="mb-10">
            <h2 className="font-display text-2xl font-semibold text-temple-midnight mb-4">1. Datenschutz auf einen Blick</h2>

            <h3 className="font-display text-lg font-semibold text-temple-midnight mb-2">Allgemeine Hinweise</h3>
            ...
            <p className="font-display text-base font-semibold text-temple-midnight mb-2">Datenerfassung auf unserer Website</p>

            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieser Website?</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Wie erfassen wir Ihre Daten?</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
              Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei kann es sich z.B. um Daten handeln, die Sie in ein Kontaktformular eingeben. Andere Daten werden automatisch beim Besuch der Website durch unsere IT-Systeme erfasst. Das sind vor allem technische Daten (z.B. Internetbrowser, Betriebssystem oder Uhrzeit des Seitenaufrufs). Die Erfassung dieser Daten erfolgt automatisch, sobald Sie unsere Website betreten.
            </p>

            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Wof&uuml;r nutzen wir Ihre Daten?</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
            ...
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
              Ausserdem haben Sie das Recht, unter bestimmten Umst&auml;nden die Einschr&auml;nkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen. Details hierzu entnehmen Sie der Datenschutzerkl&auml;rung unter &bdquo;Recht auf Einschr&auml;nkung der Verarbeitung&ldquo;.
            </p>
          </div>
          ...
          <div className="mb-10">
            <h2 className="font-display text-2xl font-semibold text-temple-midnight mb-4">2. Allgemeine Hinweise und Pflichtinformationen</h2>

            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Datenschutz</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Hinweis zur verantwortlichen Stelle</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-2">
            ...
            <div className="font-body text-foreground/80 leading-relaxed mb-4 pl-4 border-l-2 border-temple-gold">
              ...
              <p>Schweiz</p>
              <p>Telefon: +41 79 216 21 60</p>
              <p>E-Mail: becker@beckerinnovation.ch</p>
            </div>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
              Viele Datenverarbeitungsvorg&auml;nge sind nur mit Ihrer ausdr&uuml;cklichen Einwilligung m&ouml;glich. Sie k&ouml;nnen eine bereits erteilte Einwilligung jederzeit widerrufen. Dazu reicht eine formlose Mitteilung per E-Mail an uns. Die Rechtm&auml;ssigkeit der bis zum Widerruf erfolgten Datenverarbeitung bleibt vom Widerruf unber&uuml;hrt.
            </p>

            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Widerspruchsrecht gegen die Datenerhebung in besonderen F&auml;llen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Beschwerderecht bei der zust&auml;ndigen Aufsichtsbeh&ouml;rde</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
              Im Falle von Verst&ouml;ssen gegen die DSGVO steht den Betroffenen ein Beschwerderecht bei einer Aufsichtsbeh&ouml;rde, insbesondere in dem Mitgliedstaat ihres gew&ouml;hnlichen Aufenthalts, ihres Arbeitsplatzes oder des Orts des mutmasslichen Verstosses zu. Das Beschwerderecht besteht unbeschadet anderweitiger verwaltungsrechtlicher oder gerichtlicher Rechtsbehelfe.
            </p>

            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Recht auf Daten&uuml;bertragbarkeit</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">SSL- bzw. TLS-Verschl&uuml;sselung</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Auskunft, Sperrung, L&ouml;schung und Berichtigung</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
          ...
          <div className="mb-10">
            <h2 className="font-display text-2xl font-semibold text-temple-midnight mb-4">3. Datenerfassung auf unserer Website</h2>

            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Cookies</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
              Die Internetseiten verwenden teilweise so genannte Cookies. Cookies richten auf Ihrem Rechner keinen Schaden an und enthalten keine Viren. Cookies dienen dazu, unser Angebot nutzerfreundlicher, effektiver und sicherer zu machen. Cookies sind kleine Textdateien, die auf Ihrem Rechner abgelegt werden und die Ihr Browser speichert.
            </p>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
              Die meisten der von uns verwendeten Cookies sind so genannte &bdquo;Session-Cookies&ldquo;. Sie werden nach Ende Ihres Besuchs automatisch gel&ouml;scht. Andere Cookies bleiben auf Ihrem Endger&auml;t gespeichert bis Sie diese l&ouml;schen. Diese Cookies erm&ouml;glichen es uns, Ihren Browser beim n&auml;chsten Besuch wiederzuerkennen.
            </p>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
              Sie k&ouml;nnen Ihren Browser so einstellen, dass Sie &uuml;ber das Setzen von Cookies informiert werden und Cookies nur im Einzelfall erlauben, die Annahme von Cookies f&uuml;r bestimmte F&auml;lle oder generell ausschliessen sowie das automatische L&ouml;schen der Cookies beim Schliessen des Browser aktivieren. Bei der Deaktivierung von Cookies kann die Funktionalit&auml;t dieser Website eingeschr&auml;nkt sein.
            </p>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Server-Log-Dateien</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
            ...
            <h3 className="font-display text-lg font-semibold text-temple-midnight mt-6 mb-2">Kontaktformular</h3>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
              Wenn Sie uns per Kontaktformular Anfragen zukommen lassen, werden Ihre Angaben aus dem Anfrageformular inklusive der von Ihnen dort angegebenen Kontaktdaten zwecks Bearbeitung der Anfrage und f&uuml;r den Fall von Anschlussfragen bei uns gespeichert. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.
            </p>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
              Die Verarbeitung der in das Kontaktformular eingegebenen Daten erfolgt somit ausschliesslich auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Sie k&ouml;nnen diese Einwilligung jederzeit widerrufen. Dazu reicht eine formlose Mitteilung per E-Mail an uns. Die Rechtm&auml;ssigkeit der bis zum Widerruf erfolgten Datenverarbeitungsvorg&auml;nge bleibt vom Widerruf unber&uuml;hrt.
            </p>
            <p className="font-body text-foreground/80 leading-relaxed mb-4">
